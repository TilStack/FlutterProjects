        ...
        children: [
          SingleChildScrollView(
            child: Column(
                children: [
                    Container(
                      margin: const EdgeInsets.only(top: 20,right: 10,left: 10, bottom: 15),
                      child: const CardContent(title: 'My First Title', subtitle: 'The name given to a book, movie, song, or any other creative work. ', image: 'assets/png/till.png',),
                    ),
                  Container(
                    width: size.width,
                    height: 2,
                  ...
                  Container(
                    ...
                    child: GridView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          return GridCard(icon: item['icon'],title: item['title'],subtitle: item['subtitle'],);
                          },
